...
# CT connectedTo: ['MA', 'RI']
# MA connectedTo: ['CT', 'NH', 'RI', 'VT']
# RI connectedTo: ['CT', 'MA']
# NH connectedTo: ['MA', 'ME', 'VT']
# VT connectedTo: ['MA', 'NH']
# ME connectedTo: ['NH']
# dict_keys(['CT', 'MA', 'RI', 'NH', 'VT', 'ME'])
# MA in northeast (True)? True
# CA in northeast (False)? False
# MA vertex: MA connectedTo: ['CT', 'NH', 'RI', 'VT']
